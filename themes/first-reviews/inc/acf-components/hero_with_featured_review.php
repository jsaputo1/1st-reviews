...
if( $featured_post ): ?>
  ...
  <section class="hero-with-featured-review row span-page">
    <h1><?php echo get_sub_field( 'heading' ); ?></h1>
    <?php foreach( $featured_post as $post ): ?>
        <div class="featured-image col-lg-7">
          <img src="<?php echo get_the_post_thumbnail_url();?>">
          <div class="text">
            <a href="<?php echo get_the_permalink(); ?>"><?php echo get_field( 'movie_title', $post->ID ); ?></a>
            <span><?php echo get_field( 'rating', $post->ID ); ?></span>
          </div>
        </div> 
        <div class="featured-text col-lg-5">
            <h2><a href="<?php echo get_the_permalink() ?>"><?php echo get_field( 'movie_title', $post->ID ); ?></a></h2>
